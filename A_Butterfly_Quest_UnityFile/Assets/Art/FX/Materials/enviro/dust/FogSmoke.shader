	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 uv_MainTexture = packedInput.ase_texcoord1.xy * _MainTexture_ST.xy + _MainTexture_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_MainTexture = packedInput.ase_texcoord3.xy * _MainTexture_ST.xy + _MainTexture_ST.zw;
				float4 tex2DNode7 = tex2D( _MainTexture, uv_MainTexture );
...
/*ASEBEGIN
Version=18909
-1718;36;1543;983;1392.367;454.5473;1.884971;True;False
...
ASEEND*/
//CHKSM=F6802368BADBAD2BB6B557FF91A1F8F97869AE29