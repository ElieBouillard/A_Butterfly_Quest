	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 color15 = IsGammaSpace() ? float4(0.9245283,0,0,0) : float4(0.8368256,0,0,0);
				float fresnelNdotV18 = dot( normalWS, V );
				float fresnelNode18 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV18, 5.0 ) );
				
				surfaceDescription.Albedo = ( color15 * fresnelNode18 ).rgb;
...
/*ASEBEGIN
Version=18800
-1126;23;1062;996;771.2805;363.681;1;True;False
Node;AmplifyShaderEditor.ColorNode;15;-308.0503,-242.678;Inherit;False;Constant;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;0.9245283,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FresnelNode;18;-561.5623,339.0416;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.NormalVertexDataNode;17;-761.8821,-107.9997;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WorldNormalVector;13;-591,-68;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;-45.00052,-35.56769;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.DotProductOpNode;12;-335,4;Inherit;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;11;-564,118;Inherit;False;World;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
ASEEND*/
//CHKSM=8EE3B5A00826323B692DF5B79EAC5FB11306432F