...
public class SendToDrive : MonoBehaviour
{
	...
	IEnumerator InitGoogleDrive()
	{
		...
		drive.ClientID = "478804971185-i7b9s0lr70oiqusm0opjq8lmnnok97rb.apps.googleusercontent.com";
		drive.ClientSecret = "m6rKDJpGT9ndEabLSWNsrB3Y";
	...
	//	{
	//		GUI.enabled = false;
	//		GUI.Button(new Rect(10, 110, 200, 90), "Upload datas");
	//		GUI.enabled = true;
	//	}
	//	//else if (GUI.Button(new Rect(10, 110, 200, 90), "Upload datas"))
	//	//{
	//	//	StartCoroutine(UploadText());
	//	//}
...
GoogleDrive.File file = null;
	...
	IEnumerator UploadText()
	{
		...
		//{
			...
			{
				{ "title", DateTime.Now.ToString() + ".txt" },
				{ "mimeType", "text/plain" },
				{ "description", "test" }
			});
			data = new Dictionary<string, object>();
		...
		data["LeftClic"] = "" + LeftClic;
		
		data["RightClic"] = "" + RightClic;
