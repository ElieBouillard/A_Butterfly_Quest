	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float3 customSurfaceDepth15 = inputMesh.positionOS;
				float customEye15 = -TransformWorldToView(TransformObjectToWorld(customSurfaceDepth15)).z;
				o.ase_texcoord1.z = customEye15;
				float3 vertexPos7 = inputMesh.positionOS;
				float4 ase_clipPos7 = TransformWorldToHClip( TransformObjectToWorld(vertexPos7));
				float4 screenPos7 = ComputeScreenPos( ase_clipPos7 , _ProjectionParams.x );
				o.ase_texcoord2 = screenPos7;
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 texCoord22 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float4 lerpResult20 = lerp( _EndColor , _StartColor , texCoord22.y);
				float customEye15 = packedInput.ase_texcoord1.z;
				float cameraDepthFade15 = (( customEye15 -_ProjectionParams.y - 0.0 ) / _DistanceToFade);
				float4 screenPos7 = packedInput.ase_texcoord2;
				float4 ase_screenPosNorm7 = screenPos7 / screenPos7.w;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float customEye15 = packedInput.ase_texcoord.x;
				float cameraDepthFade15 = (( customEye15 -_ProjectionParams.y - 0.0 ) / _DistanceToFade);
				float4 screenPos7 = packedInput.ase_texcoord1;
				float4 ase_screenPosNorm7 = screenPos7 / screenPos7.w;
				ase_screenPosNorm7.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm7.z : ase_screenPosNorm7.z * 0.5 + 0.5;
				float screenDepth7 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm7.xy ),_ZBufferParams);
				float distanceDepth7 = abs( ( screenDepth7 - LinearEyeDepth( ase_screenPosNorm7.z,_ZBufferParams ) ) / ( _Softness ) );
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float4 lerpResult20 = lerp( _EndColor , _StartColor , texCoord22.y);
				float customEye15 = packedInput.ase_texcoord.z;
				float cameraDepthFade15 = (( customEye15 -_ProjectionParams.y - 0.0 ) / _DistanceToFade);
				float4 screenPos7 = packedInput.ase_texcoord1;
				float4 ase_screenPosNorm7 = screenPos7 / screenPos7.w;
				ase_screenPosNorm7.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm7.z : ase_screenPosNorm7.z * 0.5 + 0.5;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float customEye15 = packedInput.ase_texcoord3.x;
				float cameraDepthFade15 = (( customEye15 -_ProjectionParams.y - 0.0 ) / _DistanceToFade);
				float4 screenPos7 = packedInput.ase_texcoord4;
				float4 ase_screenPosNorm7 = screenPos7 / screenPos7.w;
				ase_screenPosNorm7.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm7.z : ase_screenPosNorm7.z * 0.5 + 0.5;
				float screenDepth7 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm7.xy ),_ZBufferParams);
				float distanceDepth7 = abs( ( screenDepth7 - LinearEyeDepth( ase_screenPosNorm7.z,_ZBufferParams ) ) / ( _Softness ) );
