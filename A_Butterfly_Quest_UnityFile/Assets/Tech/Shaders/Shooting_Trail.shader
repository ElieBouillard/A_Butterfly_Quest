...
Shader "HDRP/Particles/ShootingTrail"
{
	Properties
	{
		...
		_LifetimeMultiplicator("Lifetime Multiplicator", Range( 0 , 5)) = 1
		[Header(Main Texture)][MainTexture]_MainTexture("Main Texture", 2D) = "white" {}
		_OffsetX("OffsetX", Float) = 0
		_OffsetY("OffsetY", Float) = 0
		[Toggle]_IsSoulerCoaster("Is Souler Coaster ?", Float) = 0
		...
		[Toggle][Header(Progression Map)]_ActivateEffect4("Activate Effect", Float) = 0
		_ProgressionMap("Progression Map", 2D) = "white" {}
		_Progression("Progression", Range( 0 , 1)) = 0.7796985
		_SmoothnessProgression("Smoothness", Range( 0 , 1)) = 0
		...
		[ASEEnd]_HeadGlow("HeadGlow", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _Invert;
			float _MaskAlongUVs;
			float _ActivateEffect4;
			float _ActivateEffect2;
			float _ActivateEffect;
			float _IsSoulerCoaster;
			float _IsEmissive;
			float _SrcBlendMode;
			float _DstBlendMode;
			float _LifetimeMultiplicator;
			float _IsPanning;
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 appendResult215 = (float2(_OffsetX , _OffsetY));
				float2 appendResult8 = (float2(packedInput.ase_texcoord4.z , packedInput.ase_texcoord4.w));
				float2 texCoord26 = packedInput.ase_texcoord2.xy * _MainTexture_ST.xy + ( ( _MainTexture_ST.zw + appendResult215 ) + ( appendResult8 * temp_output_7_0 ) );
				...
				float temp_output_207_0 = ( 1.0 - _Progression );
				float4 temp_cast_6 = (temp_output_207_0).xxxx;
				float temp_output_200_0 = ( temp_output_207_0 + ( temp_output_207_0 * _SmoothnessProgression ) );
				float4 temp_cast_7 = (temp_output_200_0).xxxx;
				float2 uv_ProgressionMap = packedInput.ase_texcoord2.xy * _ProgressionMap_ST.xy + _ProgressionMap_ST.zw;
				float4 tex2DNode193 = tex2D( _ProgressionMap, uv_ProgressionMap );
				float4 smoothstepResult201 = smoothstep( temp_cast_6 , temp_cast_7 , tex2DNode193);
				float4 temp_output_206_0 = saturate( ( ( smoothstepResult201 * _ActivateEffect4 ) + step( 0.5 , ( 1.0 - _ActivateEffect4 ) ) ) );
				float4 temp_cast_8 = (_Progression).xxxx;
				float4 temp_cast_9 = (temp_output_200_0).xxxx;
				float4 smoothstepResult208 = smoothstep( temp_cast_8 , temp_cast_9 , tex2DNode193);
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord26 = packedInput.ase_texcoord.xy * _MainTexture_ST.xy + ( ( _MainTexture_ST.zw + appendResult215 ) + ( appendResult8 * temp_output_7_0 ) );
				float2 panner35 = ( ( _TimeParameters.x * _IsPanning * ( 1.0 - temp_output_7_0 ) ) * _UVPanningSPEED + ( flowedUV73 + texCoord26 ));
				float4 tex2DNode44 = tex2D( _MainTexture, panner35 );
				float mainBlueChannel129 = tex2DNode44.b;
				float temp_output_6_0 = step( 0.9 , _UseCustomVertexStreams3 );
				...
				float4 temp_output_89_0 = saturate( ( ( smoothstepResult61 * _ActivateEffect2 ) + step( 0.5 , ( 1.0 - _ActivateEffect2 ) ) ) );
				float temp_output_207_0 = ( 1.0 - _Progression );
				float4 temp_cast_4 = (temp_output_207_0).xxxx;
				float temp_output_200_0 = ( temp_output_207_0 + ( temp_output_207_0 * _SmoothnessProgression ) );
				float4 temp_cast_5 = (temp_output_200_0).xxxx;
				float2 uv_ProgressionMap = packedInput.ase_texcoord.xy * _ProgressionMap_ST.xy + _ProgressionMap_ST.zw;
				float4 tex2DNode193 = tex2D( _ProgressionMap, uv_ProgressionMap );
				float4 smoothstepResult201 = smoothstep( temp_cast_4 , temp_cast_5 , tex2DNode193);
				float4 temp_output_206_0 = saturate( ( ( smoothstepResult201 * _ActivateEffect4 ) + step( 0.5 , ( 1.0 - _ActivateEffect4 ) ) ) );
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float2 texCoord26 = packedInput.ase_texcoord1.xy * _MainTexture_ST.xy + ( ( _MainTexture_ST.zw + appendResult215 ) + ( appendResult8 * temp_output_7_0 ) );
				float2 panner35 = ( ( _TimeParameters.x * _IsPanning * ( 1.0 - temp_output_7_0 ) ) * _UVPanningSPEED + ( flowedUV73 + texCoord26 ));
				float4 tex2DNode44 = tex2D( _MainTexture, panner35 );
				float4 lerpResult55 = lerp( _SecondaryColor , _MainColor , tex2DNode44.r);
				float mainBlueChannel129 = tex2DNode44.b;
				...
				float temp_output_200_0 = ( temp_output_207_0 + ( temp_output_207_0 * _SmoothnessProgression ) );
				float4 temp_cast_7 = (temp_output_200_0).xxxx;
				float2 uv_ProgressionMap = packedInput.ase_texcoord1.xy * _ProgressionMap_ST.xy + _ProgressionMap_ST.zw;
				float4 tex2DNode193 = tex2D( _ProgressionMap, uv_ProgressionMap );
				float4 smoothstepResult201 = smoothstep( temp_cast_6 , temp_cast_7 , tex2DNode193);
				float4 temp_output_206_0 = saturate( ( ( smoothstepResult201 * _ActivateEffect4 ) + step( 0.5 , ( 1.0 - _ActivateEffect4 ) ) ) );
				float4 temp_cast_8 = (_Progression).xxxx;
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord26 = packedInput.ase_texcoord3.xy * _MainTexture_ST.xy + ( ( _MainTexture_ST.zw + appendResult215 ) + ( appendResult8 * temp_output_7_0 ) );
				float2 panner35 = ( ( _TimeParameters.x * _IsPanning * ( 1.0 - temp_output_7_0 ) ) * _UVPanningSPEED + ( flowedUV73 + texCoord26 ));
				float4 tex2DNode44 = tex2D( _MainTexture, panner35 );
				float mainBlueChannel129 = tex2DNode44.b;
				float temp_output_6_0 = step( 0.9 , _UseCustomVertexStreams3 );
				...
				float temp_output_200_0 = ( temp_output_207_0 + ( temp_output_207_0 * _SmoothnessProgression ) );
				float4 temp_cast_5 = (temp_output_200_0).xxxx;
				float2 uv_ProgressionMap = packedInput.ase_texcoord3.xy * _ProgressionMap_ST.xy + _ProgressionMap_ST.zw;
				float4 tex2DNode193 = tex2D( _ProgressionMap, uv_ProgressionMap );
				float4 smoothstepResult201 = smoothstep( temp_cast_4 , temp_cast_5 , tex2DNode193);
				float4 temp_output_206_0 = saturate( ( ( smoothstepResult201 * _ActivateEffect4 ) + step( 0.5 , ( 1.0 - _ActivateEffect4 ) ) ) );
...
/*ASEBEGIN
Version=18909
-1724;192;1194;701;3881.687;1455.242;1.379496;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;74;-3305.735,2862.44;Float;False;Property;_IsPanning4;Is Panning ?;27;1;[Toggle];Create;False;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;113;-3756.862,2926.031;Inherit;False;Property;_XYSpeedZWClampAlpha;X/Y Speed Z/W Clamp Alpha;28;0;Create;True;0;0;0;False;0;False;0,0,0,1;1,0,0,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;82;-2802.37,2473.296;Inherit;True;Property;_DistortionTexture;Distortion Texture;26;0;Create;True;0;0;0;False;0;False;-1;None;c068f140c584612469e41c535e4aa1e7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;125;-3681.808,-970.0246;Inherit;False;2408.891;1133.6;Comment;26;129;128;55;48;50;44;35;31;29;30;25;23;20;22;26;17;11;8;7;4;3;213;214;215;216;221;Main Texture;0.25178,0.4339623,0.3680638,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;218;-3165.402,-1042.688;Inherit;False;Property;_OffsetX;OffsetX;5;0;Create;True;0;0;0;False;0;False;0;-1.32;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;219;-2959.669,-1041.074;Inherit;False;Property;_OffsetY;OffsetY;6;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;4;-3629.219,-377.3701;Inherit;False;Property;_UseCustomVertexStreams2;Use Custom Vertex Streams (2.ZW);16;1;[Toggle];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;111;-2278.998,2878.308;Inherit;False;Property;_ActivateEffect3;Activate Effect;25;1;[Toggle];Create;False;0;0;0;False;1;Header(Distortion Texture);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureTransformNode;12;-3179.971,-1154.731;Inherit;False;44;False;1;0;SAMPLER2D;_Sampler012;False;2;FLOAT2;0;FLOAT2;1
...
Node;AmplifyShaderEditor.RangedFloatNode;87;-2371.349,2415.848;Inherit;False;Property;_Flow;Flow;29;0;Create;True;0;0;0;False;0;False;0;0.373;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;215;-3050.165,-886.9787;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;1;-3739.358,1196.933;Inherit;False;Property;_UseCustomVertexStreams3;Use Custom Vertex Streams (3.XY);22;1;[Toggle];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;221;-2916.383,-872.8279;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;22;-2944.179,-325.4395;Float;False;Property;_IsPanning;Is Panning ?;12;1;[Toggle];Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;30;-2949.437,-548.1766;Float;False;Property;_UVPanningSPEED;UV Panning SPEED;13;0;Create;True;0;0;0;False;0;False;1,0;-0.2,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-3032.427,1048.863;Float;False;Property;_IsPanning3;Is Panning ?;20;1;[Toggle];Create;False;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;144;-3296.923,1876.558;Inherit;False;Property;_UVMasking;U.V Masking;40;0;Create;True;0;0;0;False;0;False;1,0;1,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;21;-3185.214,862.1887;Float;False;Property;_PannerSpeed2;Panner Speed 2;21;0;Create;True;0;0;0;False;0;False;1,0;1,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;93;-2579.965,1229.564;Inherit;False;Property;_ActivateEffect;ActivateEffect;17;1;[Toggle];Create;True;0;0;0;False;1;Header(Mask Texture);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-1384.068,2885.639;Inherit;False;Property;_UseCustomVertexStreams1X;Use Custom Vertex Streams (1.X);34;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;44;-1988.642,-205.389;Inherit;True;Property;_MainTexture;Main Texture;4;0;Create;True;0;0;0;False;2;Header(Main Texture);MainTexture;False;-1;None;517ad760f7e856b4d8dcc5e3cf5d9d86;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;108;-2405.764,1017.641;Float;False;Property;_MaskCoefficient;Mask Coefficient;18;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;162;-2057.157,784.0004;Inherit;False;Property;_IsEmissive;IsEmissive;23;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-1090.361,2723.513;Inherit;False;Property;_Erosion;Erosion;32;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;146;-2883.492,1903.051;Inherit;False;Property;_MaskAlongUVs;MaskAlongUVs;39;1;[Toggle];Create;True;0;0;0;False;1;Header(Mask along UVs);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;137;-2797.54,490.8693;Inherit;False;Property;_UseBlueChannelasMask;Use Blue Channel as Mask;15;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;127;-386.3911,2320.11;Inherit;False;Property;_UseGreenChannelasErosion;Use Green Channel as Erosion;14;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;182;-774.0975,3992.846;Inherit;False;Property;_Progression;Progression;37;0;Create;True;0;0;0;False;0;False;0.7796985;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;37;-2369.862,697.6234;Inherit;True;Property;_MaskTexture;MaskTexture;19;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;40;-617.0411,2866.425;Inherit;False;Property;_Smoothness;Smoothness;33;0;Create;True;0;0;0;False;0;False;0;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;57;-226.7245,2560.517;Inherit;True;Property;_ErosionMap;Erosion Map;31;0;Create;True;0;0;0;False;0;False;-1;None;9a6174c6675a3fa4bbc29fa67a98e98c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;188;-703.1979,4164.817;Inherit;False;Property;_SmoothnessProgression;Smoothness;38;0;Create;False;0;0;0;False;0;False;0;0.4;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;154;-2305.353,1750.374;Inherit;False;Property;_Invert;Invert;41;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;207;-443.3658,4051.156;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;195;-390.7737,4141.171;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;200;-217.0852,4105.146;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;198;168.5505,4249.371;Inherit;False;Property;_ActivateEffect4;Activate Effect;35;1;[Toggle];Create;False;0;0;0;False;1;Header(Progression Map);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;193;-182.2315,3835.957;Inherit;True;Property;_ProgressionMap;Progression Map;36;0;Create;True;0;0;0;False;0;False;-1;e236ba0a72bc9ee4382e351c66ba411a;0e6573cac54dcb54bb37364838381e4c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;118;-26.01353,3049.849;Inherit;False;Property;_ActivateEffect2;Activate Effect;30;1;[Toggle];Create;False;0;0;0;False;1;Header(Erosion Effect);False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;46;-246.5754,806.7234;Float;False;Property;_Depth;Depth;44;0;Create;True;0;0;0;False;1;Header(Soft Particle);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;201;174.0441,3995.528;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;42;-590.793,263.8287;Float;False;Property;_AlphaCoefficient;Alpha Coefficient;43;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;202;364.1328,4345.414;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StepOpNode;203;553.4189,4282.187;Inherit;True;2;0;FLOAT;0.5;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;204;449.6585,4030.331;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;205;619.0082,4064.984;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SaturateNode;206;789.6663,4044.555;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.Vector4Node;214;-3457.059,-912.2083;Inherit;False;Property;_MainTexTransforms;MainTexTransforms (XY : Offset, ZW : Tiling);7;0;Create;False;0;0;0;False;0;False;0,0,1,1;0.4,0,1,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SmoothstepOpNode;208;214.6854,3666.403;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WireNode;99;199.6466,45.92113;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;220;-2658.548,-1225.704;Inherit;False;Property;_LifetimeMultiplicator;Lifetime Multiplicator;3;0;Create;True;0;0;0;True;0;False;1;1;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;210;140.3197,3383.433;Inherit;False;Property;_HeadColor;HeadColor;45;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;213;-1959.391,-588.1553;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;62;393.5727,-331.7436;Inherit;True;5;5;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;FLOAT;0;False;4;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;63;294.5184,178.2997;Inherit;True;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;163;-1454.4,431.3057;Inherit;False;Property;_EmissiveGlow;EmissiveGlow;24;0;Create;True;0;0;0;False;0;False;1;1;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;54;-405.3097,-267.3083;Float;False;Property;_Glow;Glow;11;0;Create;True;0;0;0;False;0;False;1;2.43;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;171;-1062.131,796.6245;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;68;-502.6606,-1185.221;Float;False;Property;_FakeFogColor;Fake Fog Color;42;0;Create;True;0;0;0;False;1;Header(Fake Fog);False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;217;-2629.782,-1113.127;Inherit;False;Property;_IsSoulerCoaster;Is Souler Coaster ?;8;1;[Toggle];Create;True;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;216;-3371.268,-1013.615;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;212;657.856,-211.9482;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;50;-1943.324,-972.2662;Float;False;Property;_SecondaryColor;Secondary Color;10;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,13.37858,19.69831,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;48;-1960.205,-806.2864;Float;False;Property;_MainColor;Main Color;9;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;0.140435,4.036736,5.954443,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;211;252.902,3569.866;Inherit;False;Property;_HeadGlow;HeadGlow;46;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;209;547.489,3528.106;Inherit;True;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;179;1049.348,-144.2285;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;13;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;DistortionVectors;0;6;DistortionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;True;4;1;False;-1;1;False;-1;4;1;False;-1;1;False;-1;True;1;False;-1;1;False;-1;False;False;False;False;False;False;False;False;False;False;False;True;0;True;126;False;False;False;False;False;False;False;False;False;True;True;0;True;-11;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;False;True;1;LightMode=DistortionVectors;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;176;1049.348,-144.2285;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;13;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;SceneSelectionPass;0;3;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;126;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=SceneSelectionPass;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;173;1049.348,-144.2285;Float;False;True;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;13;HDRP/Particles/ShootingTrail;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Transparent=Queue=0;True;5;0;False;True;1;0;True;123;0;True;124;1;0;True;123;0;True;124;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;126;False;False;False;False;False;False;False;False;False;True;False;0;True;-5;255;False;-1;255;True;-6;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-24;True;0;True;-32;False;True;1;LightMode=ForwardOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;29;Surface Type;1;  Rendering Pass ;0;  Rendering Pass;1;  Blending Mode;0;  Receive Fog;1;  Distortion;0;    Distortion Mode;0;    Distortion Only;1;  Depth Write;1;  Cull Mode;0;  Depth Test;4;Double-Sided;0;Alpha Clipping;0;Motion Vectors;1;  Add Precomputed Velocity;0;Shadow Matte;0;Cast Shadows;1;DOTS Instancing;0;GPU Instancing;1;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;7;True;True;True;True;True;True;False;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;175;1049.348,-144.2285;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;13;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;META;0;2;META;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;174;1049.348,-144.2285;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;13;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;ShadowCaster;0;1;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;126;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;178;1049.348,-144.2285;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;13;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;Motion Vectors;0;5;Motion Vectors;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;126;False;False;False;False;False;False;False;False;False;True;True;0;True;-9;255;False;-1;255;True;-10;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=MotionVectors;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;177;1049.348,-144.2285;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;13;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;DepthForwardOnly;0;4;DepthForwardOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;126;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;True;True;0;True;-7;255;False;-1;255;True;-8;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=DepthForwardOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
WireConnection;62;4;206;0
WireConnection;63;0;59;0
WireConnection;63;1;89;0
WireConnection;63;2;206;0
...
ASEEND*/
//CHKSM=974A28EB59AE678FCD43028EC62ACF0FF1CACB78