	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float temp_output_53_0 = ( ( tex2DNode44.a * lerpResult104 * IN.color.a * temp_output_156_0 ) * distanceDepth52 );
				float clampResult59 = clamp( temp_output_53_0 , temp_output_53_0 , 1.0 );
				float4 appendResult181 = (float4(( ( ( lerpResult55 * _Glow * IN.color * lerpResult104 * tex2DNode44.a * temp_output_156_0 * IN.color.a ) + ( IN.color * ( _EmissiveGlow * ( temp_output_165_0 * temp_output_143_0 ) ) ) ) * temp_output_89_0 * distanceDepth52 ).rgb , ( clampResult59 * temp_output_89_0 ).r));
...
/*ASEBEGIN
Version=18800
-1443;92;1127;914;2734.472;1122.556;2.768052;True;False
...
Node;AmplifyShaderEditor.VertexColorNode;47;-440.7901,457.7197;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;170;-1080.766,740.2755;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;46;-246.5754,806.7234;Float;False;Property;_Depth;Depth;33;0;Create;True;0;0;0;False;1;Header(Soft Particle);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;50;-1983.324,-726.2662;Float;False;Property;_SecondaryColor;Secondary Color;5;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;100;-477.4383,-385.1637;Inherit;False;1072.164;403.6828;Comment;5;62;164;60;172;54;Emissive Calculations;0.1503288,0.9622642,0,1;0;0
...
Node;AmplifyShaderEditor.VertexColorNode;56;-367.0217,-106.8637;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;49;-342.58,188.9301;Inherit;True;4;4;0;FLOAT;1;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;124;1093.876,-247.187;Inherit;False;Property;_DstBlendMode;DstBlendMode;1;0;Create;True;0;0;0;True;1;Enum(UnityEngine.Rendering.BlendMode);False;10;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.BreakToComponentsNode;183;-1093.827,-272.7145;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
ASEEND*/
//CHKSM=255398B3B77CB7D9F1DF1DC23E07025536056B30